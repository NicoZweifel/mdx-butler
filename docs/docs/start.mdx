...
<Info>
  Sometimes properties depend on each other or are calculated.

In this case, fields can be resolved [dynamically](/configuration#resolving-fields) in the order that they were defined in.
