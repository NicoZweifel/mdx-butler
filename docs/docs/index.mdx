...
<div className={'flex flex-col xl:flex-row gap-2'}>
  <div>
    <img className={'dark:hidden'} width={500} alt={'banner'}  src={'/logo.png'} />
    <img className={'hidden dark:block'} width={500} alt={'banner'} src={'/logo_dark.png'} />
  </div>
...
<Info>
  Fields and their [types](/configuration/#types) can be
  [dynamically](/configuration#dynamic-fields) resolved and inferred.
</Info>
  </div>
</div>
