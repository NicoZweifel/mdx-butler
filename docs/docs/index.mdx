...
<Success>
  Start editing `MDX` documents inside `/docsServer` or the configured [working
  directory](/configuration)
</Success>

## Notes

- Author mdx files in a `docsServer` folder or with [any file pattern](/configuration#options).
...
- Fully Functional responsive layout and [`neutral`](https://tailwindcss.com/docsServer/customizing-colors) color styling out of the box.
